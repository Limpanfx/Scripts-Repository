...
**Free, open-source Roblox exploiting toolkit.**

## ✨ Features
- **Universal**: Works across essentially all games to different degrees.
- **Clean UI**: Modern, dark-themed interface with smooth interactions.
- **Drag & Toggle**: Drag via topbar, toggle visibility with `RightControl` (customizable).
...
## 🤝 Contributing
- Any requests are completely welcome and you can reach me [here](https://discord.com/users/998734989279633438).
